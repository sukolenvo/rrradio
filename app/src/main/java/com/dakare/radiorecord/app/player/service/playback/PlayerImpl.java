...
public class PlayerImpl implements MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener,
        MediaPlayer.OnCompletionListener, MetadataLoader.MetadataChangeCallback, Player {
